  ...
  public function write($output) {
    ...
    if ($this->my_stringset !== null) {
      ...
      $xfer += $output->writeFieldBegin('my_stringset', TType::SET, 18);
      {
        ...
        {
          foreach ($this->my_stringset as $iter107)
          {
            if (is_scalar($iter107)) {
              $this->my_stringset[$iter107] = true;
            }
    ...
    if ($this->my_enumset !== null) {
      ...
      $xfer += $output->writeFieldBegin('my_enumset', TType::SET, 19);
      {
        ...
        {
          foreach ($this->my_enumset as $iter108)
          {
            if (is_scalar($iter108)) {
              $this->my_enumset[$iter108] = true;
            }
    ...
    if ($this->my_structset !== null) {
      ...
      $xfer += $output->writeFieldBegin('my_structset', TType::SET, 20);
      {
        ...
        {
          foreach ($this->my_structset as $iter109)
          {
            if (is_scalar($iter109)) {
              $this->my_structset[$iter109] = true;
            }
